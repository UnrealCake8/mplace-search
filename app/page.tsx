    ...
    <main className={styles.page}>
      <header className={styles.header}>
        <nav className={styles.nav} aria-label="MPlace Search links">
          ...
          <a className={styles.idButton} href="/id">
            MPlace ID
          </a>
        </nav>
      </header>
      ...
      <section
        ...
        aria-labelledby="mplace-title"
      >
        <a
          className={styles.homeBrand}
          href="/"
          id="mplace-title"
        >
        ...
        <p className={styles.note}>
          <strong>Safety filtering is always on.</strong>{" "}
          Search submitted websites and approved places without AI summaries.
        </p>
      </section>

      <footer className={styles.footer}>
        <div className={styles.footerTop}>
          MPlace Search · Part of the MPlace family
        </div>
